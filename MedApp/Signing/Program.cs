...
namespace Signing
{
    class Program
    {
        ...
        private static string dataToBeSigned = "base64DataToBeSigned=l7a1s1MNEPtO1yZhcWznrnzCErJFYVvDEqI0aojimMs%3D";
        ...
        private static string signature = "base64Signature=JF2i2JxxODBWN%2FGHaKuBH5a8m7ToXAnJQ95aINcAsfXXDc5ZhAvsud1GIEreRgeVlsOWjOzUVkQvdvqQldI0KxgulFJj36N2k28ST%2BogY%2FHhU%2BcQjBVT8kOQh0OhFTUdlOUvJRdOkC4IMqkCF7BVUvX9CnuwKfaTY1f8GgSIPNrMaONu%2F4g6h91wb7U%2FY%2B9yYWZqLSdQBir%2BnHfJd5kDUX3JN0gnkLcfibqdRxiFuQvCEPNCajp2fm11CFNE34FtDQS3IMMdu%2BG9cT5YFKFfFk7vUFQpbkqdn0L39Wu1xsBusYoZgo0k%2BPTX%2FfeBI1Jv%2Fv0eL%2BJdFO40N4F6rz5uig%3D%3D";
        ...
        public static string GetBytesToSign(string unsignedPdf, string tempPdf, string signatureFieldName)
        {
            ...
            using (PdfReader reader = new PdfReader(unsignedPdf))
            {
                using (FileStream os = File.OpenWrite(tempPdf))
                {
                    ...
                    hash = DigestAlgorithms.Digest(oso, hashAlgorithm);
        ...
        {            
            ...
            var cert = parser.ReadCertificate(toBeSigned);
